...
window.TRIVEX_I18N = {
  ua: {
    ...
    act_note_wc_tron: 'У списку WalletConnect обери гаманець із підтримкою TRON: Bitget Wallet, TokenPocket, imToken. Trust Wallet і Binance поки не підписують TRON через WalletConnect — для них скористайся ручним переказом нижче.',
    ...
    act_err_not_signed: 'Гаманець не підписав транзакцію TRON. Trust Wallet і Binance не підтримують підпис TRON через WalletConnect — скористайся TronLink, Bitget, TokenPocket або ручним переказом нижче.',
  ...
  en: {
    ...
    act_note_wc_tron: 'In the WalletConnect list, pick a wallet that supports TRON: Bitget Wallet, TokenPocket, imToken. Trust Wallet and Binance cannot sign TRON via WalletConnect yet — use the manual transfer below instead.',
    ...
    act_err_not_signed: 'The wallet did not sign the TRON transaction. Trust Wallet and Binance cannot sign TRON over WalletConnect — use TronLink, Bitget, TokenPocket, or the manual transfer below.',
