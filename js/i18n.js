...
window.TRIVEX_I18N = {
  ua: {
    ...
    act_chain_hint: 'Немає коштів у цій мережі? Обери іншу — оплату приймаємо з будь-якої.',
    act_low_gas: 'На гаманці немає {sym} для комісії мережі. Поповни трохи {sym}, інакше переказ не пройде.',
    act_note_evm_install: 'Web3-гаманець не знайдено у браузері. Встанови MetaMask, Trust, Binance або OKX і онови сторінку — або скористайся ручним переказом нижче.',
    act_note_evm_mobile: 'Відкрий trivex-landing.vercel.app у вбудованому браузері свого гаманця (MetaMask, Trust, Binance → DApp) — або скористайся ручним переказом нижче.',
    act_note_binance_app: 'Відкриваємо застосунок Binance… Якщо нічого не сталося — відкрий trivex-landing.vercel.app у Binance → Web3-гаманець → браузер dApp.',
    act_note_binance_wc: 'Обери Binance Wallet у списку WalletConnect (або встанови розширення Binance Wallet для Chrome).',
    act_open_wallet_btn: 'Відкрити гаманець →',
    act_note_transfer_only: 'Для мережі {chain} надішли USDT на адресу нижче з будь-якого гаманця чи біржі — ми знайдемо платіж автоматично.',
    act_confirming: 'Платіж знайдено, чекаємо підтверджень мережі ({n})…',
    act_order_expired: 'Час на оплату вичерпано. Онови сторінку, щоб створити нове замовлення.',
    act_watching: 'Очікуємо платіж — щойно кошти надійдуть, картка випуститься автоматично.',
    act_exact_amount: 'Надішли рівно цю суму — за нею ми впізнаємо твій платіж.',
    act_manual_check: 'Платіж не знайдено? Перевірити за хешем транзакції',
    act_or_connect: 'або підключи гаманець',
    act_pay_with: 'Сплатити через {wallet}',
    act_note_open_in_trust: 'Відкриваємо Trust Wallet… Сторінка продовжиться у вбудованому браузері гаманця, де підпис працює напряму.',
    act_open_and_pay: 'Відкрити {wallet} і сплатити',
    act_open_any_wallet: 'Відкрити інший гаманець',
    act_connect_wallet: 'Підключити гаманець',
    act_other_ways: 'Інші способи підключення',
    act_wallet_connected_label: 'Гаманець',
  ...
  en: {
    ...
    act_chain_hint: 'No funds on this network? Pick another one — we accept payment from any of them.',
    act_low_gas: 'This wallet has no {sym} for the network fee. Top up a little {sym} or the transfer will fail.',
    act_note_evm_install: 'No Web3 wallet found in this browser. Install MetaMask, Trust, Binance or OKX and refresh — or use the manual transfer below.',
    act_note_evm_mobile: 'Open trivex-landing.vercel.app in your wallet\'s built-in browser (MetaMask, Trust, Binance → DApp) — or use the manual transfer below.',
    act_note_binance_app: 'Opening the Binance app… If nothing happened, open trivex-landing.vercel.app in Binance → Web3 Wallet → dApp browser.',
    act_note_binance_wc: 'Pick Binance Wallet from the WalletConnect list (or install the Binance Wallet extension for Chrome).',
    act_open_wallet_btn: 'Open wallet →',
    act_note_transfer_only: 'On {chain}, send USDT to the address below from any wallet or exchange — we detect the payment automatically.',
    act_confirming: 'Payment found, waiting for network confirmations ({n})…',
    act_order_expired: 'The payment window has expired. Refresh the page to create a new order.',
    act_watching: 'Waiting for your payment — the card is issued automatically once it arrives.',
    act_exact_amount: 'Send exactly this amount — that is how we recognise your payment.',
    act_manual_check: 'Payment not detected? Check by transaction hash',
    act_or_connect: 'or connect a wallet',
    act_pay_with: 'Pay with {wallet}',
    act_note_open_in_trust: 'Opening Trust Wallet… The page continues inside the wallet browser, where signing works directly.',
    act_open_and_pay: 'Open {wallet} and pay',
    act_open_any_wallet: 'Open another wallet',
    act_connect_wallet: 'Connect wallet',
    act_other_ways: 'Other ways to connect',
    act_wallet_connected_label: 'Wallet',
