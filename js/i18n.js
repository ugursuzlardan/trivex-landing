...
window.TRIVEX_I18N = {
  ua: {
    ...
    act_note_transfer_only: 'Для мережі {chain} надішли USDT на адресу нижче з будь-якого гаманця чи біржі, а потім встав хеш транзакції — ми перевіримо його в мережі.',
  ...
  en: {
    ...
    act_note_transfer_only: 'On {chain}, send USDT to the address below from any wallet or exchange, then paste the transaction hash — we verify it on-chain.',
