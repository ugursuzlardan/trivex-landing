...
window.TRIVEX_I18N = {
  ua: {
    ...
    act_note_trust: 'Підключення Trust Wallet через WalletConnect вже інтегрується — буде доступне найближчим часом. Поки що скористайся TronLink або ручним переказом нижче.',
  ...
  en: {
    ...
    act_note_trust: 'Trust Wallet connection via WalletConnect is being integrated — available very soon. For now use TronLink or the manual transfer below.',
