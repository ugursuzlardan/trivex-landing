...
window.TRIVEX_I18N = {
  ua: {
    ...
    act_private_live: '🔒 ЗАКРИТЕ ТЕСТУВАННЯ · MAINNET: платежі реальні. Оплата доступна лише адміністратору. Не надсилай кошти — картки поки не випускаються.',
  ...
  en: {
    ...
    act_private_live: '🔒 CLOSED TESTING · MAINNET: payments are real. Only the operator can pay. Do not send funds — cards are not being issued yet.',
